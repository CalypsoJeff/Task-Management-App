...
const TaskStatistics2 = ({ statistics }) => {
    ...
    <>
      ...
      <div>
        ...
        {hasData ? (
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              <Pie data={memoizedStatistics} dataKey="count" nameKey="name" cx="50%" cy="50%" outerRadius={80} label>
...
export default React.memo(TaskStatistics2)
